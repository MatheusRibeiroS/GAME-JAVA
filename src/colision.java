...
public class colision {
  ...
  colision(int x1, int y1, int x2, int y2, int x3, int y3, int moveStateSkl, int moveStateUni, int moveStateSwordK, Image Skeleton[], Image Unicorn[], Image SwordKnight[]) {
    ...
    rectSwordK = new Rectangle(x3, y3, SwordKnight[moveStateSwordK].getWidth(null), SwordKnight[moveStateSwordK].getHeight(null));
    attkSkl = new Rectangle(Skeleton[moveStateSkl].getWidth(null)+10,Skeleton[moveStateSkl].getHeight(null), x1, Skeleton[moveStateSkl].getHeight(null));
    attkUni = new Rectangle(Unicorn[moveStateUni].getWidth(null)-10, Unicorn[moveStateUni].getHeight(null)-6, Unicorn[moveStateUni].getWidth(null)+10, Unicorn[moveStateUni].getWidth(null)+10);
  }
